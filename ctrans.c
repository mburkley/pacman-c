...
void updateLeaveHomeCounters_1b08 (void);
...
void setupIntroScene_04e0 (void)
{
    ...
    schedTask (TASK_BLINKY_SUBSTATE, 1);
...
void checkInactivityCounter_13dd (void)
{
    ...
    if (PINKY_SUBSTATE == 0)
    {
        PINKY_SUBSTATE = STATE_LEAVING_HOME;
        return;
    }
